...
import { POST as adminValidateSale } from "../../../admin/inventory/validate-sale/route"
...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
  ...
  const parsed = AdminValidateSaleRequest.safeParse({
    ...body,
  ...
  await adminValidateSale(req, res)
}

...
This directory contains the backend documentation for the Storflo backend.

## Contents

- `getting-started.md` — Local development, installation, and test workflow.
- `deployment.md` — Staging, production, blue/green deployment, and rollback strategy.
- `admin.md` — Admin URL and CORS configuration for production.
